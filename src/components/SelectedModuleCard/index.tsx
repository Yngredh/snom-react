    ...
    return(
        <Card
            ...
            backgroundColor={theme.pallete.cyanGreen.light}>
                ...
                <Styled.ModuleTitle>
                    <img style={{width: "8%", marginRight: "2%"}} src={`/img/modules/${props.getModuleIcone()}.svg`}></img>
            ...
            {props.selectedModuleOperation?.module?.module?.moduleType === "CLASS|Text" && <BundleEditor/>}
